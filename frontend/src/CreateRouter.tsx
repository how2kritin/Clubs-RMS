...
export const CreateRouter = () => {
    const routes = [{path: "/", element: <LandingPage/>}, {
        ...
        path: "/clubs", element: (<ProtectedRoute>
                <PageLayout customPage={ClubsPage}/>
            </ProtectedRoute>)
    }, {
        path: "/recommendations", element: (<ProtectedRoute>
        ...
        path: "/create_form/:clubId", element: (<ProtectedRoute>
                <PageLayout customPage={CreateForm}/>
            </ProtectedRoute>),
    }, {
        path: "/club/:clubId", element: (<ProtectedRoute>
                <PageLayout customPage={ClubForms}/>
            </ProtectedRoute>),
    }, {
        path: "/form/:formId", element: (<ProtectedRoute>
                <PageLayout customPage={FormView}/>
            </ProtectedRoute>),
    }, {
        path: "/apply/:formId", element: (<ProtectedRoute>
                <PageLayout customPage={ApplyToForm}/>
            </ProtectedRoute>),
    }, {
        path: "/forms/:formId/applications", element: (<ProtectedRoute>
                <PageLayout customPage={FormApplicationsOverview}/>
            </ProtectedRoute>),
    }, {
        path: "/forms/:formId/applications/:applicationId", element: (<ProtectedRoute>
                <PageLayout customPage={ApplicationDetail}/>
            </ProtectedRoute>),
    }, {
        path: "/my-applications", element: (<ProtectedRoute>
                <PageLayout customPage={UserApplications}/>
            </ProtectedRoute>),
    }, {
        path: "/schedule_interviews", element: (<ProtectedRoute>
                <PageLayout customPage={ScheduleInterviews}/>
            </ProtectedRoute>)
    }, {
        path: "/calendar", element: (<ProtectedRoute>
