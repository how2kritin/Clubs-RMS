...
from utils.session_utils import (SESSION_COOKIE_NAME, check_current_user,
                                 get_current_user, )  # Added invalidate_session for logout
...
async def update_user_profile(profile_update: UserProfileUpdate,  # Use Pydantic model for validation
